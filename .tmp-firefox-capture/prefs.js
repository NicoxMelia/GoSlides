...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1788875615);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1788879215);
user_pref("app.update.lastUpdateTime.glean-addons-daily", 1788875615);
user_pref("app.update.lastUpdateTime.region-update-timer", 1788875615);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1788875615);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1788875615);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1788875615);
...
user_pref("browser.crashReports.cleanupCheck.lastDate", "2026-09-08T13:58:27.359Z");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{947e5a74-7da4-437c-aa98-c5f8ac899748}");
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1788875585155");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1788897185155");
user_pref("browser.search.update", false);
user_pref("browser.sessionstore.resume_from_crash", false);
user_pref("browser.shell.mostRecentDateSetAsDefault", "1788875586");
user_pref("browser.startup.couldRestoreSession.count", -1);
user_pref("browser.startup.homepage_override.mstone", "ignore");
user_pref("browser.startup.lastColdStartupCheck", 1788875587);
...
user_pref("captchadetection.lastSubmission", 1788875);
...
user_pref("extensions.lastAppBuildId", "20260827225302");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"ba38b6f8-bd13-49d0-bd8a-f804e8f5769a\",\"ipp-activator@mozilla.com\":\"e93bc71c-e923-4145-af58-f194ac7b96de\",\"pictureinpicture@mozilla.org\":\"04764c80-10e9-4631-a8f1-aca37a3e2c86\",\"addons-search-detection@mozilla.com\":\"4a2c1843-c2c3-470b-9f1c-1affc22b99e2\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"newtab@mozilla.org\":\"0c655ad6-8b08-43bf-85b9-8bd9a2c4e4d4\",\"default-theme@mozilla.org\":\"233937a6-389f-4071-841d-6382a5a5e339\"}");
...
user_pref("idle.lastDailyNotification", 1788877020);
...
user_pref("media.gmp-gmpopenh264.lastDownload", 1788875755);
user_pref("media.gmp-gmpopenh264.lastInstallStart", 1788875754);
user_pref("media.gmp-gmpopenh264.lastUpdate", 1788875755);
user_pref("media.gmp-gmpopenh264.version", "2.6.0");
user_pref("media.gmp-manager.buildID", "20260827225302");
user_pref("media.gmp-manager.lastCheck", 1788875754);
...
user_pref("nimbus.profileId", "0b3a9e9b-c88c-49a2-835b-089fd1bf5d3b");
user_pref("pdfjs.enabledCache.state", true);
user_pref("pdfjs.migrationVersion", 2);
user_pref("permissions.isolateBy.userContext", true);
user_pref("places.database.lastMaintenance", 1788877020);
user_pref("privacy.bounceTrackingProtection.hasMigratedUserActivationData", true);
user_pref("privacy.purge_trackers.date_in_cookie_database", "0");
user_pref("privacy.purge_trackers.last_purge", "1788877020308");
...
user_pref("storage.vacuum.last.places.sqlite", 1788877020);
user_pref("telemetry.fog.test.localhost_port", -1);
user_pref("termsofuse.bypassNotification", true);
user_pref("toolkit.profiles.storeID", "bc1761ad");
user_pref("toolkit.startup.last_success", 1788875582);
...
user_pref("toolkit.telemetry.previousBuildID", "20260827225302");
